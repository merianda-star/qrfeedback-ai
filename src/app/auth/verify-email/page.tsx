      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .icon-ring {
          ...
          background: linear-gradient(135deg, #fef3e8, #f7ece9);
        ...
        .title {
          ...
          font-size: 1.5rem; color: #2a1f1d; margin-bottom: 10px; line-height: 1.25;
        }

        .sub {
          font-size: 0.84rem; color: #7a5a56; line-height: 1.7; margin-bottom: 24px;
        }

        .email-pill {
          display: inline-block; background: #f7ece9; border: 1px solid #e8d5cf;
          border-radius: 20px; padding: 6px 16px;
          font-size: 0.82rem; font-weight: 600; color: #b05c52;
          margin-bottom: 28px;
        }
        ...
        .resend-btn {
          ...
          border: 1.5px solid #e8d5cf; background: #ffffff;
          font-size: 0.8rem; font-weight: 600; color: #7a5a56;
        ...
        .back-login {
          font-size: 0.8rem; color: #b09490; text-decoration: none;
        ...
        .spam-note {
          margin-top: 20px; font-size: 0.7rem; color: #c9aba6;
          line-height: 1.6; padding: 10px 14px;
          background: #fdf6f4; border-radius: 8px; border: 1px solid #e8d5cf;
        }
        ...
        <div className="card">
          ...
          <div className="steps">
            ...
            <div className="step-row">
              ...
              <div className="step-text">Open the email from <strong>QRFeedback.ai</strong></div>
            </div>
            <div className="step-row">
              <div className="step-num">2</div>
              <div className="step-text">Click the <strong>"Confirm my email"</strong> button</div>
            </div>
            <div className="step-row">
              <div className="step-num">3</div>
              <div className="step-text">You'll be taken straight to your dashboard</div>
            </div>
          </div>
